            ...
            @endif 
               ...
               <td style="padding: 16px 10px; width: 20px">
                  <!-- Button trigger modal -->
                    <button type="button" class="btn btn-sm btn-default" style="display: block" data-toggle="modal" data-target="#eliminarModal" data-id="{{$motivoC->id}}"> <!-- data- es atributo que me permite enviar una variable al modal para poder ser accedida en ete caso envío la variable data-id -->
                      Eliminar
                    </button>
               </td>
            </tr>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      ...
                      <form action="{{route('motivoConsulta.destroy',1)}}"  data-action="{{route('motivoConsulta.destroy',1)}}" method="POST" id="form-delete">
                        @csrf
                        @method('DELETE')
